...
| 7 → Package **(manual)** | `/package <slug>` + `agent7_package.py --render` | Opus 4.8 strategies (in-session) + Gemini 3 Pro Image render (`gemini-3-pro-image-preview`, ~4K) | `04_final.md` (script) | `md/07_package.md` + `md/07_prompts.md` + `thumbnails_no_grain/thumbnail_0N.png` × 3 |
