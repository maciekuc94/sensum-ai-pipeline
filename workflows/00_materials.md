...
```bash
python tools/agent0_materials.py --topic "psychology of fear" --pdf "materials/The Fear Factor.pdf"
```
...
2. Sends the full book text + topic to Gemini 2.5 Flash (1M context — handles any book size)
...
4. Saves output to `outputs/[slug]/00_materials_insights.md`

---

## Review

Open `outputs/[slug]/00_materials_insights.md`. Skim the extracted insights:
...
| File | Description |
|------|-------------|
| `outputs/[slug]/00_materials_insights.md` | Structured insights extracted from the book |
