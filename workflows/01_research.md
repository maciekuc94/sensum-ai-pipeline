...
|--------|-----------------|
| Vertex AI Gemini 2.5 Pro + Google Search Grounding | Narrative overview, key concepts, researcher names, cited studies from the live web |
...
[1/2] Querying Gemini 2.5 Pro with Google Search Grounding...
[2/2] Querying PubMed API...

Synthesizing results into markdown...

Saved: outputs/emotional-dysregulation-in-adhd/01_research.md
...
Open `outputs/[slug]/01_research.md` in any markdown viewer or text editor.
