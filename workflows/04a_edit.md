...
1. **Agent 3 must have run successfully.** The file
   `outputs/[slug]/md/03_script_draft.md` must exist.
...
3. **Style guide** — `workflows/style_guide.md` must exist in the project root.
...
[4/4] Saving output to 04_script_final.md...
  Saved: outputs/emotional-dysregulation-in-adhd/md/04_script_final.md
...
Open `outputs/[slug]/md/04_script_final.md` and work through these questions before
...
The file `workflows/style_guide.md` is missing from the project root.
...
- **Claude edits prose, not facts.** Agent 4a does not re-verify scientific
  ...
  against `outputs/[slug]/md/02_verified_research.md` and the original papers
  before publishing.
