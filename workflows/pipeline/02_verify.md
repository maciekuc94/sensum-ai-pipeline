...
Vertex AI Gemini 3.1 Pro, and asks the model to categorise every factual
...
[2/3] Verifying claims with Gemini 3.1 Pro...
  Initializing Vertex AI (project=my-project, location=us-central1)...
  Querying Gemini 3.1 Pro for claim verification...
