...
in [workflows/guides/narrative_architectures.md](../guides/narrative_architectures.md) under
"Visual Register Maps" and are mirrored in `VISUAL_REGISTER_MAPS` inside
[tools/pipeline/agent5_visuals.py](../../tools/pipeline/agent5_visuals.py).
...
[narrative_architectures.md → Visual Register Maps](../guides/narrative_architectures.md)
for the full table.
...
Open `outputs/videos/{slug}/md/05_image_prompts.md`. This is the only manual gate before
...
```bash
python tools/pipeline/agent9_images.py "emotional-dysregulation-in-adhd" --generate
```
