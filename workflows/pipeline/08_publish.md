...
- _Optional:_ latest `outputs/intelligence/*_tag_signals.md` (auto-produced by Agent 11 alongside the weekly PPTX). Agent 8 uses it as the highest-priority signal for tag selection when present; behaves identically if absent.
...
In this video, we explore [concept 1] — [brief framing] — alongside [concept 2], [concept 3], and what research on [concept 4] actually tells us about [audience-relevant angle].
...
## YouTube Tags
tag1, tag2, ... (exactly 15, single-word only)
```
